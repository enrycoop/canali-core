...
public class BuildMiniIndex {
	...
	public BuildMiniIndex(String basePathInput, String basePathOutput) {
...
//	}
	...
	public static void main(String[] args) throws Exception {
		...
		if (args != null && args.length == 2) {
			...
			fn1 = "/home/lucia/nlp2sparql-data/dbpedia-processed/2015-10/miniSupportFiles/";
			fn2 = "/home/lucia/nlp2sparql-data/dbpedia-processed/2015-10/miniIndex/";
		}
		long start = System.currentTimeMillis();
                System.out.println("BUILD MINI INDEX");
		System.out.println("Started at " + new Date());
		new BuildMiniIndex(fn1, fn2).start();
